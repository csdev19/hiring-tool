...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "border-border bg-card text-card-foreground gap-4 overflow-hidden rounded-xl border py-4 text-sm/relaxed has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:gap-2 data-[size=sm]:py-3 data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl group/card flex flex-col",
        className,
      )}
      {...props}
    />
