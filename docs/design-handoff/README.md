...
3. Pasa los archivos de `screens/` uno por uno para rediseñar cada pantalla respetando su estructura funcional (lo que se documenta aquí es *qué hace y qué muestra* cada pantalla; el layout puede cambiar).
