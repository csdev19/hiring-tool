...
description: Complete guide to using the @interviews-tool/web-ui package, including theming, colors, and adding shadcn components
date: 2025-01-01
tags:
  - ui
  - components
...
The `@interviews-tool/web-ui` package is a shared UI component library that provides reusable React components, styles, and utilities for all applications in the monorepo.
...
```tsx
import { Dialog, DialogContent, DialogTrigger } from "@interviews-tool/web-ui";
```
...
// ❌ Bad
import { Button } from "@interviews-tool/web-ui/components/button";
```
...
1. Verify styles are imported: `@import "@interviews-tool/web-ui/styles.css";`
...
2. **Update imports** to use `@interviews-tool/web-ui`
