...
- [Concept V1](/docs/planning/concept) - Original product concept
- [System Overview](/docs/architecture/system-overview) - System architecture
- [Implementation Summary](/docs/features/hiring-process/implementation-summary) - Previous feature implementation
- [Web UI Package](/docs/frontend/web-ui-package) - UI component library documentation
