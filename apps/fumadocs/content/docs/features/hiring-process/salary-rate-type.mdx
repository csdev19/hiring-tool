...
- [Constants Pattern](/docs/architecture/constants-pattern) - Pattern used for domain constants
- [Schemas Implementation](/docs/architecture/schemas-implementation) - Domain schema patterns
- [Features Status](/docs/planning/features-status) - Overall feature tracking
- [Hiring Process](index) - Parent feature
